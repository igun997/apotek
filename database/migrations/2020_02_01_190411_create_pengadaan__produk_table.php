...
class CreatePengadaanProdukTable extends Migration {
	...
	public function up()
	{
		Schema::create('pengadaan__produk', function(Blueprint $table)
		{
			$table->string('id_pengadaan_produk', 60)->primary();
